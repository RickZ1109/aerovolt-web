...
const CircuitSection = () => {
  const steps = [
    'Fixe firmemente o motor DC na sua base.',
    'Encaixe as hélices no eixo do motor.',
    'Monte o circuito na protoboard seguindo o diagrama técnico.',
    'Conecte os fios de saída do motor à entrada do circuito na protoboard.',
    'Teste o sistema com um ventilador para verificar se os LEDs acendem.'
  ];

  return (
    <section id="circuito" className="section-padding bg-white">
          ...
          <div className="mb-16">
            ...
            >
              <img 
                ...
                alt="Diagrama técnico do circuito AeroVolt"
               src="https://images.unsplash.com/photo-1521118213897-df6fef51f4e1" />
            </motion.div>
          </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                >
                  <img 
                    className="w-full h-64 object-cover" 
                    alt="Passo 2 da montagem"
                   src="https://images.unsplash.com/photo-1555775802-5d8e2e0bd7e5" />
                </motion.div>
