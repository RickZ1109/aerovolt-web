...
const ComponentsSection = () => {
  const components = [
    '1x Motor DC 5,5V (usado como gerador)',
    '1x Hélice/Ventoinha',
    '1x Capacitor de 100uf 16V (para estabilizar a tensão gerada)',
    '4x LEDs 5mm de 2V em média (qualquer cor)',
    '4x Resistores de 200 Ohms',
    '1x Protoboard (Placa de Ensaio) e Fios Jumper',
    'Base para montagem (madeira, acrílico, etc.)'
  ];

  return (
    <section id="componentes" className="section-padding bg-gradient-to-b from-slate-50 to-white">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            >
              <img 
                ...
                alt="Componentes do projeto AeroVolt organizados"
               src="https://images.unsplash.com/photo-1577962144759-8dec6b55c952" />
            </motion.div>
          </div>
        </motion.div>
      </div>
