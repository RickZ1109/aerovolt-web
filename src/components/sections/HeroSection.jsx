...
const HeroSection = () => {
  return <section id="inicio" className="min-h-screen flex items-center justify-center pt-16 bg-gradient-to-br from-blue-50 via-cyan-50 to-slate-50">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.8
            ...
            delay: 0.5
              ...
              <a href="#introducao" className="px-8 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl">
                Começar
              </a>
              <a href="#demonstracao" className="px-8 py-3 bg-white text-blue-600 border-2 border-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
                Ver Demonstração
              </a>
            </motion.div>
          </motion.div>
          ...
          delay: 0.2
            ...
            <div className="aspect-square rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center">
              <img className="w-full h-full object-cover" alt="Projeto AeroVolt montado e finalizado" src="https://horizons-cdn.hostinger.com/175eb958-ff92-4b2f-b873-ce3ec5c8222b/projeto-r8lZe.jpeg" />
            </div>
